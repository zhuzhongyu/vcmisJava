...
public class CheckIndex {
  ...
  public static class Status {
    ...
    public static class SegmentInfoStatus {
       ...
       *  has position data
       *  @see AbstractField#setIndexOptions(org.apache.lucene3_4.index.FieldInfo.IndexOptions) */
  ...
  /** Command-line interface to check and fix an index.
    ...
    Run it like this:
    <pre>
    java -ea:org.apache.lucene3_4... org.apache.lucene3_4.index.CheckIndex pathToIndex [-fix] [-segment X] [-segment Y]
    </pre>
    <ul>
  ...
  public static void main(String[] args) throws IOException, InterruptedException {
    ...
    if (indexPath == null) {
      ...
      System.out.println("\nUsage: java org.apache.lucene3_4.index.CheckIndex pathToIndex [-fix] [-segment X] [-segment Y]\n" +
                         "\n" +
    ...
    if (!assertsOn())
      System.out.println("\nNOTE: testing will be more thorough if you run java with '-ea:org.apache.lucene3_4...', so assertions are enabled");
