...
public class AverageGuessMemoryModel extends MemoryModel {
   ...
   * (non-Javadoc)
   * 
   * @see org.apache.lucene3_4.util.MemoryModel#getArraySize()
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see org.apache.lucene3_4.util.MemoryModel#getClassSize()
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see org.apache.lucene3_4.util.MemoryModel#getPrimitiveSize(java.lang.Class)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see org.apache.lucene3_4.util.MemoryModel#getReferenceSize()
   */
  @Override
