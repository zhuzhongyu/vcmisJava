...
/**
 * 麻醉、第一类精神药品处方笺--门(急)诊病历 H/D/2009122912004.xml
 * @author WangZhendong
 * 
 */
public class AnesthesiaTheFirstClassOfPsychotropicDrugsPrescriptionTab extends Table {
    ...
    private String[] Keys={"AnesthesiaTheFirstClassOfPsychotropicDrugsPrescriptionTab"};
