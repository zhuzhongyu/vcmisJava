...
/**
 * 第三次随访--服药依从性 对应标记 HR51_01_179_3
 * 
 * @author rp
 */
public class DrugCompliance3 extends Meta {
	public String metaname = "第三次随访--服药依从性";
	String[] SIds = new String[] { "fyycx3" };
