...
/**
 * 第一次随访--转诊--原因 对应标记 HR52_02_044_1
 * 
 * @author rp
 */
public class ReferralReason1 extends Meta {
	public String metaname = "第一次随访--转诊--原因";
	String[] SIds = new String[] { "zzyy1" };
