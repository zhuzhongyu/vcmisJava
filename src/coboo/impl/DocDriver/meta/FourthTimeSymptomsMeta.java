 package coboo.impl.DocDriver.meta;
  ...
  /**
	 * 症状
	 * cbtjbzz30,cbtjbzz31,cbtjbzz32,cbtjbzz33,cbtjbzz34,cbtjbzz35,cbtjbzz36,cbtjbzz37,cbtjbzz38
	 * @author WangZhendong
	 *
	 */
public    class FourthTimeSymptomsMeta extends Meta {
    	public String metaname=" 症状 ";
		String[] SIds = new String[]{ "zzz4_1:cbtjbzz30","zz4_2:cbtjbzz31","zz4_3:cbtjbzz32",
				   "zz4_4:cbtjbzz33","zz4_5:cbtjbzz34","zz4_6:cbtjbzz35",
                   "zz4_7:cbtjbzz36","zz4_8:cbtjbzz37","zzqt4:cbtjbzz38"};
		...
		void con_svalue2hvalue(String[] storeValueList) {
			if (storeValueList[0].equals("1")) {
				HValue = "无症状";
					...
					HValue = str1 + "/" + str2 + "/" + str3 
					+ "/" + str4 + "/" + str5 + "/" + str6 + "/" + str7 + "/" + storeValueList[8];
			        
			}
			top();
			return;
		} 
		public FourthTimeSymptomsMeta(){
			top();
		}
		void top(){
			super.SIds=SIds;
