...
/**
 * 第一次随访--下次随访日期 对应标记 HR42_02_057_5
 * 
 * @author rp
 */
public class DateOfNextFollowUp1 extends Meta {
	public String metaname = " 第一次随访--下次随访日期";
	String[] SIds = new String[] { "xcsfrq1" };
