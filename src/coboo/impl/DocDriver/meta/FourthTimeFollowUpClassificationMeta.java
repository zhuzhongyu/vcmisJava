...
/**
 * 此次随访分类 HR55_01_037_4
 * 
 * @author WangZhendong
 * 
 */
public class FourthTimeFollowUpClassificationMeta extends Meta {
	String metaname = " 此次随访分类 ";
	String[] SIds = new String[] { "sffl4:HR55_01_037_4" };
	...
	public FourthTimeFollowUpClassificationMeta() {
		top();
	}
