...
/**
 * 第三次随访--生活方式指导--日吸烟量右面格 对应标记 HR51_01_108_22
 * 
 * @author rp
 */
public class OnSmokingRight3 extends Meta {
	public String metaname = "第三次随访--生活方式指导--日吸烟量右面格";
	String[] SIds = new String[] { "rxyl6" };
