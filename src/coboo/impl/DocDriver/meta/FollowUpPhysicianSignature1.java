...
/**
	 ...
	 * @author rp  
	 */
public class FollowUpPhysicianSignature1 extends Meta{
		public String metaname=" 第一次随访--随访医生签名";
		String[] SIds = new String[]{ "sfysqm1"};
		...
		public FollowUpPhysicianSignature1(){
			top();
		}
		void top(){
			super.SIds=SIds;
