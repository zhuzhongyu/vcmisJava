...
/**
 * 第二次随访--下次随访日期 对应标记 HR42_02_057_6
 * 
 * @author rp
 */
public class DateOfNextFollowUp2 extends Meta {
	public String metaname = " 第二次随访--下次随访日期";
	String[] SIds = new String[] { "xcsfrq2" };
