...
/**
 * 第四次随访--转诊--原因 对应标记 HR52_02_044_4
 * 
 * @author rp
 */
public class ReferralReason4 extends Meta {
	public String metaname = "  第四次随访--转诊--原因";
	String[] SIds = new String[] { "zzyy4" };
