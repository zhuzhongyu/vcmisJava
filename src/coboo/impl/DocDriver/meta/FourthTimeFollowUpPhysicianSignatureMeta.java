 package coboo.impl.DocDriver.meta;
	 ...
	 * @author WangZhendong
	 */
public class FourthTimeFollowUpPhysicianSignatureMeta extends Meta {
		public String metaname=" 随访医生签名  ";
		String[] SIds = new String[]{ "ysqm4:cbsfysqm4"};
		...
		public FourthTimeFollowUpPhysicianSignatureMeta(){
			top();
		}
		void top(){
			super.SIds=SIds;
