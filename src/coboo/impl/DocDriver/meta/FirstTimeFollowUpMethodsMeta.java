...
/**
 * 第一次随访方式 HR52_01_036_1
 * 
 * @author WangZhendong
 * 
 */
public class FirstTimeFollowUpMethodsMeta extends Meta {
	public String metaname = "第一次随访方式";
	String[] SIds = new String[] { "sffs1：HR52_01_036_1" };
	...
	public FirstTimeFollowUpMethodsMeta() {
		top();
	}
