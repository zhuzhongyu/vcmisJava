 package coboo.impl.DocDriver.meta;
	...
	/**
	 * 进食
	 * 对应字段 cbpg_2_js_c, cbpg_2_js_z, cbpg_2_js_m, cbpg_1_js_c
	 * cbpg_1_js_z, cbpg_1_js_m, cbpg_0_js_c, cbpg_0_js_z, cbpg_0_js_m
	 * @author 任笑言
	 */
public	class EatMeta extends Meta{
	public String metaname="进食";
	String[] SIds = new String[]{ "cbpg_2_js_c:cc19", "cbpg_2_js_z:zq19", "cbpg_2_js_m:mq19",
			"cbpg_1_js_c:cc20", "cbpg_1_js_z:zq20", "cbpg_1_js_m:mq20",
			"cbpg_0_js_c:cc21", "cbpg_0_js_z:zq21", "cbpg_0_js_m:mq21"};
