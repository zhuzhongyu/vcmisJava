...
/**
 * 已接受康复：精神综合防治 对应字段 cbcjrjszh
 * 
 * @author 任笑言
 */
public class AlreadyCureMeta extends Meta {
	public String metaname = "已接受康复：精神综合防治";
	String[] SIds = new String[] { "cbcjrjszh:jszhfz1" };
