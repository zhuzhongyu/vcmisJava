...
/**
 * 第四次随访--下次随访日期 对应标记 HR42_02_057_8
 * 
 * @author rp
 */
public class DateOfNextFollowUp4 extends Meta {

	public String metaname = " 第四次随访--下次随访日期";
	String[] SIds = new String[] { "xcsfrq4" };
