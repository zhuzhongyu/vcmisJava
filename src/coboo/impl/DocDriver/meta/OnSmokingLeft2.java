...
/**
 * 第二次随访--生活方式指导--日吸烟量左面格 对应标记 HR51_01_108_11
 * 
 * @author rp
 */
public class OnSmokingLeft2 extends Meta {
	public String metaname = "第二次随访--生活方式指导--日吸烟量左面格";
	String[] SIds = new String[] { "rxyl3" };
