...
/**
 * 第二次随访--生活方式指导--日吸烟量右面格 对应标记 HR51_01_108_12
 * 
 * @author rp
 */
public class OnSmokingRight2 extends Meta {
	public String metaname = "第二次随访--生活方式指导--日吸烟量右面";
	String[] SIds = new String[] { "rxyl4" };
