...
/**
 * 第三次随访--生活方式指导--遵医行为 HR55_01_035_3
 * 
 * @author rp
 */
public class TreatmentCompliance3 extends Meta {
	String metaname = "第三次随访--生活方式指导--遵医行为";
	String[] SIds = new String[] { "zyxw3" };
