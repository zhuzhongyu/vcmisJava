...
/**
 * 第一次随访--转诊--机构及科别 对应标记 HR21_01_022_1
 * 
 * @author rp
 */
public class AgenciesAndDivisions1 extends Meta {
	public String metaname = "第一次随访--转诊--机构及科别";
	String[] SIds = new String[] { "jgjkb1" };
