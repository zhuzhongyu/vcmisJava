...
/**
 * 血压
 * "cbxy02", "HR51_02_173_120" 
 */
public class SecondTimeBloodPressureMeta extends Meta {
	public String metaname = " 辅助检查 ";
	String[] SIds = new String[] { "xy2:cbxy02", "xy2:HR51_02_173_12" };
	...
	public SecondTimeBloodPressureMeta() {
		top();
	}
