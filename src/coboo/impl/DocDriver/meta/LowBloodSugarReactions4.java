...
/**
 * 第四次随访--低血糖反应 对应标记 cbdxtfy4
 * 
 * @author rp
 */
public class LowBloodSugarReactions4 extends Meta {
	public String metaname = " 第四次随访--低血糖反应";
	String[] SIds = new String[] { "cbdxtfy4" };
	...
	public LowBloodSugarReactions4() {
		top();
	}
