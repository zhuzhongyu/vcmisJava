 ...
 * 
 */
public class ThirdTimePsychologicalAdjustmentMeta extends Meta {
	public String metaname = " 心理调整 ";
	String[] SIds = new String[] { "xltz3:HR54_02_013_01_3" };
	...
	public ThirdTimePsychologicalAdjustmentMeta() {
		top();
	}
