...
/**
 * 已接受康复：其他 对应字段 cbcjrqt
 * 
 * @author 任笑言
 */
public class AlreadyOtherMeta extends Meta {
	public String metaname = "已接受康复：其他";
	String[] SIds = new String[] { "cbcjrqt:qt1" };
