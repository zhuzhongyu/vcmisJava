...
/**
 * 第一次随访--低血糖反应 对应标记 cbdxtfy1
 * 
 * @author rp
 */
public class LowBloodSugarReactions1 extends Meta {
	public String metaname = " 第一次随访--低血糖反应";
	String[] SIds = new String[] { "cbdxtfy1" };
	...
	public LowBloodSugarReactions1() {
		top();
	}
