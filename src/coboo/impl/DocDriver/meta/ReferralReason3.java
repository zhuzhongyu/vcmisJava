...
/**
 * 第三次随访--转诊--原因 对应标记 HR52_02_044_3
 * 
 * @author rp
 */
public class ReferralReason3 extends Meta {
	public String metaname = "第三次随访--转诊--原因";
	String[] SIds = new String[] { "zzyy3" };
