...
/**
 * 站 
 * cbpg_2_l_c, cbpg_2_l_z, cbpg_2_l_m, cbpg_1_l_c cbpg_1_l_z, cbpg_1_l_m,
 * cbpg_0_l_c, cbpg_0_l_z, cbpg_0_l_m
 * @author 任笑言
 */
public class StoodMeta extends Meta {
	public String metaname = "站";
	String[] SIds = new String[] {"cbpg_2_l_c:cc7", "cbpg_2_l_z:zq7", "cbpg_2_l_m:mq7",
			"cbpg_1_l_c:cc8", "cbpg_1_l_z:zq8", "cbpg_1_l_m:mq8", "cbpg_0_l_c:cc9",
			"cbpg_0_l_z:zq9", "cbpg_0_l_m:mq9" };
