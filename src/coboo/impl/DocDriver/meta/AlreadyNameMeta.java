...
/**
 * 已使用器具：名称 对应字段 cbcjryydj_mc
 * 
 * @author 任笑言
 */
public class AlreadyNameMeta extends Meta {
	public String metaname = "已使用器具：名称";
	String[] SIds = new String[] { "cbcjryydj_mc:mc1" };
