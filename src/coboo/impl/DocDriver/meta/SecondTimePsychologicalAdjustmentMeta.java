 ...
 * 
 */
public class SecondTimePsychologicalAdjustmentMeta extends Meta {
	public String metaname = " 心理调整 ";
	String[] SIds = new String[] { "xltz2:HR54_02_013_01_2" };
	...
	public SecondTimePsychologicalAdjustmentMeta() {
		top();
	}
