...
/**
 * 第一次随访--生活方式指导--遵医行为 HR55_01_035_1
 * 
 * @author rp
 */
public class TreatmentCompliance1 extends Meta {
	String metaname = "第一次随访--生活方式指导--遵医行为";
	String[] SIds = new String[] { "zyxw1" };
