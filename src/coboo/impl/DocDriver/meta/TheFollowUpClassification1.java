...
/**
 * 第一次随访--此次随访分类 HR55_01_037_1
 * 
 * @author rp
 */
public class TheFollowUpClassification1 extends Meta {
	public String metaname = "第一次随访--此次随访分类";
	String[] SIds = new String[] { "sffl1" };
	...
	public TheFollowUpClassification1() {
		top();
	}
