...
/**
	 * 第一次随访--用药情况--用法3--每次几mg
	 * 对应标记 HR52_01_037_03_03
	 * @author rp  
	 */
public	class EveryFewMg31 extends Meta{
		public String metaname=" 第一次随访--用药情况--用法3--每次几mg";
		String[] SIds = new String[]{ "ywmc14"};
