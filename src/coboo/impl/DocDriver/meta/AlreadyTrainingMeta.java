...
/**
 * 已接受康复：训练 对应字段 cbcjrxl
 * 
 * @author 任笑言
 */
public class AlreadyTrainingMeta extends Meta {
	public String metaname = "已接受康复：训练";
	String[] SIds = new String[] { "cbcjrxl:xl1" };
