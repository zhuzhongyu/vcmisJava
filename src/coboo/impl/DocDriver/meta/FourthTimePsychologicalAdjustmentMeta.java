...
/**
	 ...
	 *
	 */
    public class FourthTimePsychologicalAdjustmentMeta extends Meta {
    	public String metaname=" 心理调整 ";
		String[] SIds = new String[]{ "xltz4:HR54_02_013_01_4"};
		...
		public FourthTimePsychologicalAdjustmentMeta(){
			top();
		}
		void top(){
			super.SIds=SIds;
