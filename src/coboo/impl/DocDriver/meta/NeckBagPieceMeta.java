...
/**
 * 颈部包块 对应字段 cbjbbk1,cbjbbk2
 * 
 * @author 任笑言
 * 
 */
public class NeckBagPieceMeta extends Meta {
	public String metaname = "颈部包块";
	String[] SIds = new String[] { "cbjbbk1", "cbjbbk2" };
