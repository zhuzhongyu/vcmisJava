...
/**
 * 第三次随访--辅助检查--其他检查--其它 对应标记 cbqt7
 * 
 * @author rp
 */
public class OtherChecksOther3 extends Meta {
	public String metaname = "第三次随访--辅助检查--其他检查--其它";
	String[] SIds = new String[] { "xtqt3" };
