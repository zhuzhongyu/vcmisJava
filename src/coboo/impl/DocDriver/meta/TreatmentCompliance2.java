...
/**
 * 第二次随访--生活方式指导--遵医行为 HR55_01_035_2
 * 
 * @author rp
 */
public class TreatmentCompliance2 extends Meta {
	String metaname = "第二次随访--生活方式指导--遵医行为";
	String[] SIds = new String[] { "zyxw2" };
