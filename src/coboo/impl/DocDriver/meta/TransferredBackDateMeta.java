...
/**
	 ...
	 */
	// ============================== 双向转诊(回转)单--日期 =================================
public	class TransferredBackDateMeta extends Meta {
		public String metaname = "双向转诊(回转)单--日期";
		String[] SIds = new String[] {"cbsxzz_zzn_2","cbsxzz_zzy_2","cbsxzz_zzr_2"};
		...
		public TransferredBackDateMeta() {
			top();
		}
