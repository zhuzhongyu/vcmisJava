...
/**
 * 第三次随访--此次随访分类 HR55_01_037_3
 * 
 * @author rp
 */
public class TheFollowUpClassification3 extends Meta {
	public String metaname = "第三次随访--此次随访分类";
	String[] SIds = new String[] { "sffl3" };
	...
	public TheFollowUpClassification3() {
		top();
	}
