...
/**
	 ...
	 * @author rp  
	 */
public	class FollowUpPhysicianSignature2 extends Meta{
		public String metaname=" 第二次随访--随访医生签名";
		String[] SIds = new String[]{ "sfysqm2"};
		...
		public FollowUpPhysicianSignature2(){
			top();
		}
		void top(){
			super.SIds=SIds;
