...
/**
 * 第四次随访--转诊--机构及科别 对应标记 HR21_01_022_4
 * 
 * @author rp
 */
public class AgenciesAndDivisions4 extends Meta {
	public String metaname = "第四次随访--转诊--机构及科别";
	String[] SIds = new String[] { "jgjkb4" };
