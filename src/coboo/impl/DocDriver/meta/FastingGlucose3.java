...
/**
 * 第三次随访--辅助检查--空腹血糖值 对应标记 HR51_03_092_3
 * 
 * @author rp
 */
public class FastingGlucose3 extends Meta {
	public String metaname = "第三次随访--辅助检查--空腹血糖值";
	String[] SIds = new String[] { "kfxtz3" };
