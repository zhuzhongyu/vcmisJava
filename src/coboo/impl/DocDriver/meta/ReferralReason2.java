...
/**
 * 第二次随访--转诊--原因 对应标记 HR52_02_044_2
 * 
 * @author rp
 */
public class ReferralReason2 extends Meta {
	public String metaname = " 第二次随访--转诊--原因";
	String[] SIds = new String[] { "zzyy2" };
