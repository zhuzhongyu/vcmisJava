 ...
 * @author WangZhendong
 */
public class SecondTimeFollowUpPhysicianSignatureMeta extends Meta {
	public String metaname = " 随访医生签名 ";
	String[] SIds = new String[] { "ysqm2:cbsfysqm2" };
	...
	public SecondTimeFollowUpPhysicianSignatureMeta() {
		top();
	}
