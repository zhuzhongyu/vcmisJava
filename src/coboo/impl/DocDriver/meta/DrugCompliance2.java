...
/**
 * 第二次随访--服药依从性 对应标记 HR51_01_179_2
 * 
 * @author rp
 */
public class DrugCompliance2 extends Meta {
	public String metaname = "第二次随访--服药依从性";
	String[] SIds = new String[] { "fyycx2" };
