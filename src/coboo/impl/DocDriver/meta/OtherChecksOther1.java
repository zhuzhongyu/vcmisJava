...
/**
 * 第一次随访--辅助检查--其他检查--其它 对应标记 cbqt5
 * 
 * @author rp
 */
public class OtherChecksOther1 extends Meta {
	public String metaname = " 第一次随访--辅助检查--其他检查--其它";
	String[] SIds = new String[] { "xtqt1" };
