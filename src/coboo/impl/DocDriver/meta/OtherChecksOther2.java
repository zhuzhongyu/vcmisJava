...
/**
 * 第二次随访--辅助检查--其他检查--其它 对应标记 cbqt6
 * 
 * @author rp
 */
public class OtherChecksOther2 extends Meta {
	public String metaname = " 第二次随访--辅助检查--其他检查--其它";
	String[] SIds = new String[] { "xtqt2" };
