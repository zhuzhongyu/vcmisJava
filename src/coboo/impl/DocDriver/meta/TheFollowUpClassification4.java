...
/**
 * 第四次随访--此次随访分类 HR55_01_037_4
 * 
 * @author rp
 */
public class TheFollowUpClassification4 extends Meta {
	public String metaname = " 第四次随访--此次随访分类";
	String[] SIds = new String[] { "sffl4" };
	...
	public TheFollowUpClassification4() {
		top();
	}
