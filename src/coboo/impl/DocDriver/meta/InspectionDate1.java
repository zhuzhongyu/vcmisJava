...
/**
 * 第一次随访--辅助检查--其他检查--检查日期 对应标记 HR42_02_009_1
 * 
 * @author rp
 */
public class InspectionDate1 extends Meta {
	public String metaname = "第一次随访--辅助检查--其他检查--检查日期";
	String[] SIds = new String[] { "xtrq1" };
