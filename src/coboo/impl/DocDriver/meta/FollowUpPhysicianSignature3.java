...
/**
	 ...
	 * @author rp  
	 */
public	class FollowUpPhysicianSignature3 extends Meta{
		public String metaname=" 第三次随访--随访医生签名";
		String[] SIds = new String[]{ "sfysqm3"};
		...
		public FollowUpPhysicianSignature3(){
			top();
		}
		void top(){
			super.SIds=SIds;
