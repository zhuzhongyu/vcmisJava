...
/**
	 * 第四次随访--用药情况--用法2--每次几mg
	 * 对应标记 HR52_01_037_03_32
	 * @author rp  
	 */
public	class EveryFewMg24 extends Meta{
		public String metaname=" 第四次随访--用药情况--用法2--每次几mg";
		String[] SIds = new String[]{ "yf16"};
