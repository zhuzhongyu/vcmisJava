...
/**
 * 第二次随访--低血糖反应 对应标记 cbdxtfy2
 * 
 * @author rp
 */
public class LowBloodSugarReactions2 extends Meta {
	public String metaname = "第二次随访--低血糖反应";
	String[] SIds = new String[] { "cbdxtfy2" };
	...
	public LowBloodSugarReactions2() {
		top();
	}
