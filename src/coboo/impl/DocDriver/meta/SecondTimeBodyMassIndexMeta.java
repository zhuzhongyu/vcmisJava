 ...
 * HR51_02_021_2
 */
public class SecondTimeBodyMassIndexMeta extends Meta {
	public String metaname = " 体质指数 ";
	String[] SIds = new String[] { "tzzs2:HR51_02_021_2" };
	...
	public SecondTimeBodyMassIndexMeta() {
		top();
	}
