...
/**
 * 下次随访日期 HR42_02_057_5
 * 
 * @author WangZhendong
 */
public class FirstTimeDateOfNextFollowUpMeta extends Meta {
	public String metaname = "下次随访日期";
	String[] SIds = new String[] { "xc1:HR42_02_057_5" };
	...
	public FirstTimeDateOfNextFollowUpMeta() {
		top();
	}
