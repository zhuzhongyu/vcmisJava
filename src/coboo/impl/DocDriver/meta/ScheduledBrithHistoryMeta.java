...
/**
 * 孕产史
 * "cbycs_01","cbycs_02","cbycs_03","cbycs_04"
 */
public class ScheduledBrithHistoryMeta extends Meta {
	public String metaname = "孕产史";
	String[] SIds = new String[] { "lccb:cbycs_01", "st:cbycs_02", "swcb:cbycs_03",
			"sse:cbycs_04" };
	...
	public ScheduledBrithHistoryMeta() {
		top();
	}
