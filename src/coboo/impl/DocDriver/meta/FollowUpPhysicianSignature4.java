...
/**
	 ...
	 * @author rp  
	 */
public	class FollowUpPhysicianSignature4 extends Meta{
		public String metaname=" 第四次随访--随访医生签名";
		String[] SIds = new String[]{ "sfysqm4"};
		...
		public FollowUpPhysicianSignature4(){
			top();
		}
		void top(){
			super.SIds=SIds;
