...
/**
 * 通讯地址 对应字段 HR03_00_003
 * 
 * @author 任笑言
 */
public class PostalAddressMeta extends Meta {
	public String metaname = "通讯地址";
	String[] SIds = new String[] { "txdz:HR03_00_003" };
