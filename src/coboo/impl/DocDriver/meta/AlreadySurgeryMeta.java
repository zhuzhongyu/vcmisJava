...
/**
 * 已接受康复：手术 对应字段 cbcjrss
 * 
 * @author 任笑言
 */
public class AlreadySurgeryMeta extends Meta {
	public String metaname = "已接受康复：手术";
	String[] SIds = new String[] { "cbcjrss:ss1" };
