...
/**
 * 第二次随访--转诊--机构及科别 对应标记 HR21_01_022_2
 * 
 * @author rp
 */
public class AgenciesAndDivisions2 extends Meta {
	public String metaname = "第二次随访--转诊--机构及科别";
	String[] SIds = new String[] { "jgjkb2" };
