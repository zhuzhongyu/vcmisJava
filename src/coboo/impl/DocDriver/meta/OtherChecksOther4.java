...
/**
 * 第四次随访--辅助检查--其他检查--其它 对应标记 cbqt8
 * 
 * @author rp
 */
public class OtherChecksOther4 extends Meta {
	public String metaname = "第四次随访--辅助检查--其他检查--其它";
	String[] SIds = new String[] { "xtqt4" };
