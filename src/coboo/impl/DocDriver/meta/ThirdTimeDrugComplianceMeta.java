 ...
 * 
 */
public class ThirdTimeDrugComplianceMeta extends Meta {
	public String metaname = " 药物依从性查 ";
	String[] SIds = new String[] { "fyycx3:HR51_01_179_3" };
	...
	public ThirdTimeDrugComplianceMeta() {
		top();
	}
